...
class AdvImageToFeat(object):
    ...
    def doit(self, raw_image, at_first=True, mask=None):
        ...
        #print('image shape: ', self.mutated_image.shape)
        ...
        #print('mask shape: ', self.mutated_mask.shape)
        ...
        #print('_out_features: ', self.predictor.model.backbone._out_features)
        ...
        # print('boxes: ', proposal.proposal_boxes)
        ...
        #print('Box features size: ', box_features.shape)
        feature_pooled = box_features.mean(dim=[2, 3])  # pooled to 1x1
        #print('feature_pooled requires_grad: ', feature_pooled.requires_grad)
        ...
        #print('roi_features requires_grad: ', roi_features.requires_grad)
    ...
    def mutate_from_grad(self, grad, lr=0.01):
        #assert grad.shape[0] == self.NUM_OBJECTS
        ...
        # print('grad shape: ', self.mutated_image.grad[0].shape)
        # print('image shape: ', self.original_image.shape)
