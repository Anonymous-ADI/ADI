...
from oscar.modeling.modeling_bert import ImageBertForSequenceClassification, ImageBertForSequenceClassificationOriginal
...
MODEL_CLASSES = {
    'bert': (BertConfig, ImageBertForSequenceClassificationOriginal, BertTokenizer),
}
...
class VQADataset(Dataset):
    ...
    def tensorize_example(self, example, cls_token_at_end=False, pad_on_left=False,
        ...
        return (torch.tensor(input_ids, dtype=torch.long), # need, list of ids
                torch.tensor(input_mask, dtype=torch.long), # need
                torch.tensor(segment_ids, dtype=torch.long), # need
                torch.tensor([label_id[0]], dtype=torch.long),
...
def main():
    ...
    ## Required parameters
    parser.add_argument("--data_dir", default='/root/data/Oscar/vqa/2k', type=str, required=False,
                        help="The input data dir. Should contain the .tsv files (or other data files) for the task.")
    parser.add_argument("--txt_data_dir", default='/root/data/Oscar/vqa/2k', type=str, required=False,
                        help="The input text data dir. Should contain the .json files (or other data files) for the task.")

    parser.add_argument("--model_type", default='bert', type=str, required=False,
                        help="Model type selected in the list: " + ", ".join(MODEL_CLASSES.keys()))
    parser.add_argument("--model_name_or_path", default='/root/collection/pretrained-models/Oscar/large_best/', type=str, required=False,
    ...
    parser.add_argument("--label_file", type=str, default='/root/collection/pretrained-models/Oscar/trainval_ans2label.pkl', help="Label Dictionary")
    parser.add_argument("--label2ans_file", type=str, default='/root/collection/pretrained-models/Oscar/trainval_label2ans.pkl', help="Label to Answer Dictionary")
